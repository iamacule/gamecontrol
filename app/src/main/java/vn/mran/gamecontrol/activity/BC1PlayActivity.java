...
public class BC1PlayActivity extends AppCompatActivity implements View.OnClickListener, FirebaseRequest.OnFirebaseRequestChanged {
    ...
    private void initValue() {
        FirebaseDatabase.getInstance().getReference("BC1").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (ruleChildPlay.status.equals(RuleChildPlay.ON)) {
                    getEdtRuleNumber().setText(String.valueOf(ruleChildPlay.rule));

                    String[] assignNumberArrays = ruleChildPlay.assignNumber.split(" ");
                    ...
                    getEdtRuleQuantum().setText(String.valueOf(ruleChildPlay.quantum));
                    getEdtRuleAdditionalNumber().setText(String.valueOf(ruleChildPlay.additionalNumber));
                }

                //Rule Mai
                RuleMainPlay ruleMainPlay = dataSnapshot.child("RuleMainPlay").getValue(RuleMainPlay.class);
                if (ruleMainPlay.status.equals(RuleMainPlay.ON)) {
                    getEdtMainQuantum().setText(String.valueOf(ruleMainPlay.quantum));
                }

                //Rule Offline
                RuleOfflinePlay ruleOfflinePlay = dataSnapshot.child("RuleOfflinePlay").getValue(RuleOfflinePlay.class);
                if (ruleOfflinePlay.status.equals(RuleOfflinePlay.ON)) {
                    String[] assignNumberArrays = ruleOfflinePlay.assignNumber.split(" ");
                    ...
                    getEdtOfflineQuantum().setText(String.valueOf(ruleOfflinePlay.quantum));
                    getEdtOfflineAdditionalNumber().setText(String.valueOf(ruleOfflinePlay.additionalNumber));
                }

                getEdtText().setText(dataSnapshot.child("TextPlay").getValue().toString());
            }
        ...
        if (isOnline()) {
            ...
            switch (view.getId()) {
                case R.id.btnSetMain:
                    ...
                    bc1Write.writeRuleMainPlay(new RuleMainPlay(mainRuleQuantum, RuleMainPlay.ON));
                ...
                case R.id.btnOffMain:
                    ...
                    bc1Write.writeRuleMainPlay(new RuleMainPlay(0, RuleMainPlay.OFF));
                    Toast.makeText(getApplicationContext(), getString(R.string.sent), Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btnSetOffline:
                    ...
                    bc1Write.writeRuleOfflinePlay(new RuleOfflinePlay(additionalNumber, bc1Write.exportAssignNumber(assignNumberArrays), ruleQuantum, RuleOfflinePlay.ON));
                    Toast.makeText(getApplicationContext(), getString(R.string.sent), Toast.LENGTH_SHORT).show();
                    break;
                ...
                case R.id.btnOffRule1:
                    ...
                    bc1Write.writeRuleChildPlay(new RuleChildPlay(additionalNumber, bc1Write.exportAssignNumber(assignNumberArrays), ruleQuantum, ruleNumber, RuleOfflinePlay.OFF));
                    Toast.makeText(getApplicationContext(), getString(R.string.sent), Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btnText:
                    bc1Write.writeTextPlay(getEdtText().getText().toString().trim());
                    Toast.makeText(getApplicationContext(), getString(R.string.sent), Toast.LENGTH_SHORT).show();
                    break;
            }
        } else {
